    ...
    <main className="min-h-screen">
      ...
      <section className="py-16 px-4">
        <div className="container mx-auto max-w-5xl text-center">
          {/* Badge */}
          <div className="inline-flex items-center gap-2 bg-[#2d8a39] text-white px-4 py-2 rounded-full text-sm mb-6">
          ...
          {/* Description */}
          <p className="text-gray-600 leading-relaxed max-w-4xl mx-auto">{content?.intro?.description}</p>
        </div>
      </section>
                ...
                <button
                  ...
                  className={cn(
                    ...
                    activeCategory === category.id
                      ...
                      : "bg-white text-gray-600 border border-gray-300 hover:border-[#2d8a39] hover:text-[#2d8a39]",
                  )}
                >
                  {category.name}
                </button>
